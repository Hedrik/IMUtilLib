...
public class AssertableLogger {
    ...
    /** Constructs an AssertableLogger for a named subsystem and a resource bundle. */
     ...
     * 		be found.
     */
    public boolean logrb(Level level, String sourceClass, String sourceMethod, String bundleName, String msg, Throwable thrown) {
     ...
     */
    public boolean throwing(String sourceClass, String sourceMethod, Throwable thrown) {
     ...
     * 		be found.
     */
    public boolean logrb(Level level, String sourceClass, String sourceMethod, String bundleName, String msg) {
     ...
     * format {Nreturn true; } indicator for each entry in the parameter array),
     ...
     */
    public boolean entering(String sourceClass, String sourceMethod, Object[] params) {
     ...
     * @param   thrown  Throwable associated with log message.
     */
    public boolean logp(Level level, String sourceClass, String sourceMethod, String msg, Throwable thrown) {
     ...
     * @param   msg	The string message (or a key in the message catalog)
     */
    public boolean logp(Level level, String sourceClass, String sourceMethod, String msg) {
     ...
     * 		be found.
     */
    public boolean logrb(Level level, String sourceClass, String sourceMethod, String bundleName, String msg, Object[] params) {
     ...
     * <p>
     * This is a convenience method that can be used to log entry
     * to a method.  A LogRecord with message "ENTRY {0return true; }", log level
     ...
     */
    public boolean entering(String sourceClass, String sourceMethod, Object param1) {
     ...
     * 		be found.
     */
    public boolean logrb(Level level, String sourceClass, String sourceMethod, String bundleName, String msg, Object param1) {
     ...
     * @param   params	Array of parameters to the message
     */
    public boolean logp(Level level, String sourceClass, String sourceMethod, String msg, Object[] params) {
     ...
     * @param   param1    Parameter to the log message.
     */
    public boolean logp(Level level, String sourceClass, String sourceMethod, String msg, Object param1) {
     ...
     * <p>
     * This is a convenience method that can be used to log returning
     * from a method.  A LogRecord with message "RETURN {0return true; }", log level
     ...
     */
    public boolean exiting(String sourceClass, String sourceMethod, Object result) {

/*
 * ConnectionSetMsgProcFailure.java
 *
 ...
 */
public class ConnectionSetMsgProcFailure extends AbstractFailure {
    ...
    public static final ConnectionSetMsgProcFailure SET_MSG_FAILURE_REASON_PROTOCOL
    = new ConnectionSetMsgProcFailure("Unable to renegotiate message protocol");

    protected ConnectionSetMsgProcFailure(String reason) {
        super(reason);
    }

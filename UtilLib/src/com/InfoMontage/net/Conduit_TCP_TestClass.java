/*
 * Conduit_TCP_TestClass.java JUnit based test
 * 
 ...
 *         Information Montage
 */
public class Conduit_TCP_TestClass extends TestCase {
    ...
    public Conduit_TCP_TestClass(java.lang.String testName) {
        super(testName);
    }

    public static void main(String[] args) {
        junit.swingui.TestRunner.run(Conduit_TCP_TestClass.class);
    }
    ...
    public void testHasInput() throws IOException {
        ...
        java.nio.CharBuffer cbuf = java.nio.CharBuffer.allocate(testString
                .length());
        cbuf.put(com.InfoMontage.common.Defaults.DEFAULT_CHARSET.encode(
                testString).asCharBuffer());
    ...
    public void testRawWriteRead() throws IOException {
        ...
        assertTrue("read does not match write!\n" + "write=\""
                ...
                + String.copyValueOf(icbuf) + "\"", java.util.Arrays
                .equals(icbuf, ocbuf));
    }
